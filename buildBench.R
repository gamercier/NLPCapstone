# buildBenchmark.R
# Generates data for optimizing and measuring performance of
# our guessing algorithm.
...
# Read a sample
# Preprocess the data as done for fixRawCorpus.R
# Create test data - quadgrams, trigrams, bigrams, unigrams
# For each generate 1000 items.
